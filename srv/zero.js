...
zero.sendMessage(from, anu, image, {quoted: ftrol, caption: 'Done Jangan Lupa Subscribe Zero YT7' })
break
case 'hartatahta':
case 'naruto':
case 'bneon':
...
zero.sendMessage(from, res, image, {quoted: ftrol, caption: 'Done Jangan Lupa Subscribe Zero YT7' })
break
case 'wolflogo':
case 'pubglogo':
case 'snowwrite':
...
zero.sendMessage(from, wll, image, {quoted: ftrol, caption: 'Done Jangan Lupa Subscribe Zero YT7' })
break
case 'blackpink':
case 'neon':
case 'greenneon':
...
zero.sendMessage(from, blck, image, {quoted: ftrol, caption: 'Done Jangan Lupa Subscribe Zero YT7' })
break
case 'ssweb':
...
zero.sendMessage(from, hasil, image, { thumbnail: Buffer.alloc(0), caption: `Done Jangan Lupa Subscribe Zero YT7`, quoted : ftrol})
})
break
case 'asupan':
...
zero.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Zero YT7'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${apikey5}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zero.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Zero YT7'})
break
case 'asupanhijaber':
